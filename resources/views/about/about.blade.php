...
@section('content')
  ...
  <body data-spy="scroll" data-target=".site-nav-target" data-offset="200">
      ...
      <div class="container">
        ...
        <div class="row gutter-v3">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="feature-v1" data-aos="fade-up" data-aos-delay="0">
              <div class="wrap-icon mb-3 text-center">
                <img class="services-img" src="images/svg/translator.png" alt="Image" width="45" data-gif="images/svg/translator.gif">
              </div>
              <h3>دورات اللغات<br>الأجنبية</h3>
              <p>دورات لتعلم اللغات الأجنبية من المستوى المبتدئ حتى المتقدم، تشمل أيضًا ورشات للمستويات المتقدمة لتحسين الطلاقة في التواصل</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="feature-v1" data-aos="fade-up" data-aos-delay="100">
              <div class="wrap-icon mb-3">
                <img class="services-img" src="images/svg/writing.png" alt="Icon" width="45" data-gif="images/svg/writing.gif">
              </div>
              <h3>دورات تحسين<br>الخط</h3>
              <p>دورات لتحسين الكتابة والخط في اللغة العربية واللغات الأجنبية، مخصصة للأطفال واليافعين </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
              <div class="wrap-icon mb-3">
                <img class="services-img" src="images/svg/abacus.png" alt="Image" class="img-fluid" width="45" data-gif="images/svg/abacus.gif">
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="feature-v1" data-aos="fade-up" data-aos-delay="0">
              <div class="wrap-icon mb-3">
                <img class="services-img" src="images/svg/achieve.png" alt="Image" width="45" data-gif="images/svg/achieve.gif">
              </div>
              <h3>جلسات فردية<br>للأهداف الخاصة</h3>
              <p>جلسات مخصصة لتحسين المهارات اللغوية أو التحضير لاختبارات اللغات الأجنبية، تُركز على احتياجاتكم الخاصة لضمان أفضل النتائج </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="feature-v1" data-aos="fade-up" data-aos-delay="100">
              ...
              <p>مكتبة تحتوي على أكثر من 300 عنوان مختلف، متاحة للاستعارة من قبل الطلاب لدعم التعليم المستمر وتوسيع المعرفة </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="feature-v1" data-aos="fade-up" data-aos-delay="200">
              <div class="wrap-icon mb-3">
                <img class="services-img" src="images/svg/school.png" alt="Image" width="45" data-gif="images/svg/school.gif">
              </div>
              <h3>الموارد التكنولوجية<br>المتقدمة</h3>
              <p>نوفر أدوات وموارد تكنولوجية حديثة لدعم العملية التعليمية، مما يساعد في تحسين تجربة التعلم وتطوير المهارات باستخدام أحدث التقنيات </p>
            </div>
          </div>
    ...
    <!-- END .counter --><div class="unslate_co--section" id="portfolio-section">
        <div class="container">
