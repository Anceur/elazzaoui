        ...
        <div class="col-12">
          <div class="row justify-content-center ">
            <div class="col-lg-6 text-center ">
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100" style="font-family: 'Amiri', serif;">اتصل بنا</h1>
        ...
        <div class="col-lg-4 mb-5 order-2 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
          <div class="contact-info">
            ...
            <div class="email mt-4">
              ...
              <h4 class="mb-2">بريد إلكتروني</h4>
              <p>info@Untree.co</p>
            </div>

            <div class="phone mt-4">
              <i class="icon-phone"></i>
              <h4 class="mb-2">يتصل</h4>
              <p>+213 0559180536</p>
            </div>
          ...
          <form action="#">
            <div class="row">
              <div class="col-6 mb-3" >
                <input type="text" class="form-control" placeholder="اسمك" style="    text-align: right;" >
              </div>
              <div class="col-6 mb-3">
                <input type="email" class="form-control" placeholder="بريدك الإلكتروني" style="    text-align: right;">
              </div>
              <div class="col-12 mb-3">
                <input type="text" class="form-control" placeholder="الموضوع" style="    text-align: right;">
              </div>
              <div class="col-12 mb-3">
                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="رسالتك" style="    text-align: right;"></textarea>
              </div>
        
              <div class="col-12">
                <input type="submit" value="إرسال الرسالة" style="    text-align: right;" class="btn btn-primary">
              </div>
            </div>
          </form>
        </div>
