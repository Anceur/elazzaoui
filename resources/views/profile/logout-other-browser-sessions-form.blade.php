<x-action-section>
    ...
    <x-slot name="description">
        {{ __('إدارة وتسجيل الخروج من الجلسات النشطة على المتصفحات والأجهزة الأخرى.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('إذا لزم الأمر، يمكنك تسجيل الخروج من جميع جلسات المتصفح الأخرى عبر جميع أجهزتك. يتم عرض بعض جلساتك الحديثة أدناه، لكن قد لا تكون هذه القائمة شاملة. إذا شعرت بأن حسابك تعرض للاختراق، يجب عليك تحديث كلمة المرور أيضًا.') }}
        </div>
